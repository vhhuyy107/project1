...
$sum_a = array_sum($a);
$sum_b = array_sum($b);
echo "<br> Tổng các giá trị trong mảng a = $sum_a , mảng b= $sum_b "."<br/>";

$aGiam=$a; rsort($aGiam);
echo "<br/>Mang sau khi giam: ";
showArray($aGiam);

$bGiamNew=$b; rsort($bGiamNew);
echo "<br/>Mang b sau khi giam loai bo key la: ";
showArray($bGiamNew);

$bGiamGiuKey=$b; arsort($bGiamGiuKey);
echo "<br/>Mang b sau khi giam giu lai key la: ";
showArray($bGiamGiuKey);
