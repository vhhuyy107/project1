...
<table  align="center">
	...
	<tr><td>Thông tin: </td><td><textarea name="thong_tin" id="" cols="30" rows="10"><?php echo $thong_tin;?></textarea></td></tr>
...
if ($sm !="")
{
	...
	$thong_tin_updated = stripslashes($thong_tin);
	?>
    <div class="info">
    	<?php 
			if ($err !="") echo $err;
			else
			  {
				...
				echo "Mật khẩu đã mã hóa Md5 & SHA1:".sha1(md5($password1)) ."<br>";
				echo "Họ tên: ". ucwords($name)."<br>";  
				echo "Thông tin: ".$thong_tin."<br>";
				echo "Thông tin_v2: ".$thong_tin_updated;
			}
		?>
    </div>
    <?php
